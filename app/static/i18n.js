...
const TRANSLATIONS = {
  nl: {
    ...
    "help.robot_move": "Alleen nodig als de robot wit speelt: laat de openingszet uitvoeren (jij speelt zwart). Daarna reageert de robot via de klok (get move).\nCommando naar de arm: move <uci>\n(bijv. move e2e4)",
    "color.white": "wit",
    "color.black": "zwart",
    // engine
    "panel.engine": "Engine (Stockfish)",
    "panel.candidates": "Kandidaten",
    "engine.auto": "Automodus: antwoord automatisch op \"get move\"",
    "engine.pgn_mode": "Speel vanuit PGN-database (anders Stockfish)",
    "help.pgn_mode": "Als dit aan staat, zoekt de robot eerst in de gekozen PGN-database naar dezelfde stelling (EPD). Bij een treffer wordt willekeurig een historische zet gespeeld; anders Stockfish.",
    "engine.pgn_variations": "Ook varianten meenemen",
    "help.pgn_variations": "Als dit aan staat, worden naast de hoofdlijn ook PGN-zijvarianten (zetten tussen haakjes) meegenomen bij het zoeken naar historische zetten.",
    "label.pgn_database": "PGN-database",
    "option.pgn_none": "— geen —",
    "btn.pgn_upload": "Uploaden",
    "btn.pgn_search": "Zoek",
    "help.pgn_search": "Zoek in de actieve PGN-database naar historische zetten voor de huidige stelling op het bord. Resultaten verschijnen in de kandidatentabel; er wordt geen zet uitgevoerd.",
    "btn.pgn_delete": "Verwijderen",
    "hint.pgn_database": "Upload .pgn-bestanden met gespeelde partijen. Bij een bekende stelling speelt de robot een historische zet.",
    "pgn.db_choose": "Kies eerst een .pgn-bestand om te uploaden",
    "pgn.db_delete_confirm": "Database \"{name}\" verwijderen?",
    "pgn.db_delete_none": "Selecteer eerst een database om te verwijderen",
    "label.elo": "ELO",
    ...
    "engine.last_move_db": "Laatste database-zet: {move}",
    "source.database": "PGN-database",
    "source.database_hint": "PGN-suggesties",
    "source.stockfish": "Stockfish",
    "engine.pgn_suggestions": "Suggesties uit PGN (jij speelt zelf)",
    "engine.pgn_suggestions_none": "Geen PGN-suggesties voor jouw zet",
    "th.move": "Zet",
    "th.score": "Score",
    "th.count": "Aantal",
    "th.line": "Lijn",
    ...
    "pgn.choice_count": "{count}× gespeeld",
    // testpaneel
    ...
    "recovery.title": "Scan komt niet overeen",
    "recovery.body": "De robotscan wijkt af van de stelling in de app. De app blijft leidend; er wordt opnieuw gescand tot het klopt.",
    "recovery.robot": "Robot",
    "recovery.app": "App",
    "recovery.stop": "Stop",
    ...
    "cmd.toon-text": "toon_text – toon tekst op armscherm (max 10; optioneel ,seconden; ,0 = blijft)",
    "cmd.toon-text.ph": "bijv. Henk, Henk,5 of Henk,0",
    "test.toon_stays": "blijft",
    ...
    "contact.intro": "Stuur een bericht. Je e-mailadres wordt alleen gebruikt om te antwoorden.",
    "contact.name": "Naam",
    ...
    "contact.success": "Bericht verstuurd. Bedankt!",
    "contact.error": "Versturen mislukt. Probeer het later opnieuw.",
    "contact.error_required": "Vul naam, e-mail en bericht in.",
    "contact.captcha_needed": "Rond de beveiligingscontrole van Formspree af in het geopende venster, daarna is je bericht verstuurd.",
  },
  en: {
    ...
    "help.robot_move": "Only needed when the robot plays white: execute the opening move (you play black). After that the robot responds via the clock (get move).\nCommand to the arm: move <uci>\n(e.g. move e2e4)",
    "color.white": "white",
    "color.black": "black",
    "panel.engine": "Engine (Stockfish)",
    "panel.candidates": "Candidates",
    "engine.auto": "Auto mode: respond automatically to \"get move\"",
    "engine.pgn_mode": "Play from PGN database (otherwise Stockfish)",
    "help.pgn_mode": "When enabled, the robot first searches the selected PGN database for the same position (EPD). On a hit, a historical move is chosen at random; otherwise Stockfish.",
    "engine.pgn_variations": "Include variations too",
    "help.pgn_variations": "When enabled, PGN side variations (moves in parentheses) are included when searching for historical moves, not only the main line.",
    "label.pgn_database": "PGN database",
    "option.pgn_none": "— none —",
    "btn.pgn_upload": "Upload",
    "btn.pgn_search": "Search",
    "help.pgn_search": "Search the active PGN database for historical moves for the current board position. Results appear in the candidates table; no move is executed.",
    "btn.pgn_delete": "Delete",
    "hint.pgn_database": "Upload .pgn files with played games. For a known position the robot plays a historical move.",
    "pgn.db_choose": "Choose a .pgn file to upload first",
    "pgn.db_delete_confirm": "Delete database \"{name}\"?",
    "pgn.db_delete_none": "Select a database to delete first",
    "label.elo": "ELO",
    ...
    "engine.last_move_db": "Last database move: {move}",
    "source.database": "PGN database",
    "source.database_hint": "PGN suggestions",
    "source.stockfish": "Stockfish",
    "engine.pgn_suggestions": "PGN suggestions (you play yourself)",
    "engine.pgn_suggestions_none": "No PGN suggestions for your move",
    "th.count": "Count",
    "pgn.choice_count": "played {count}×",
    "th.move": "Move",
    "th.score": "Score",
    "th.line": "Line",
    ...
    "recovery.title": "Scan mismatch",
    "recovery.body": "The robot scan differs from the position in the app. The app stays authoritative; rescanning until it matches.",
    "recovery.robot": "Robot",
    "recovery.app": "App",
    "recovery.stop": "Stop",
    ...
    "cmd.toon-text": "toon_text – show text on arm screen (max 10; optional ,seconds; ,0 = stays)",
    "cmd.toon-text.ph": "e.g. Henk, Henk,5 or Henk,0",
    "test.toon_stays": "stays",
    ...
    "footer.contact": "Contact",
    "contact.title": "Contact",
    "contact.intro": "Send a message. Your email is only used to reply.",
    "contact.name": "Name",
    "contact.email": "Email",
    ...
    "contact.error": "Sending failed. Please try again later.",
    "contact.error_required": "Please fill in name, email and message.",
    "contact.captcha_needed": "Complete the Formspree security check in the opened window; your message will be sent after that.",
  },
};
